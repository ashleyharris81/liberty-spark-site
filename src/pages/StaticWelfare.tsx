        ...
        <div className="relative h-[60vh] min-h-[400px] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex items-center">
            <div className="container mx-auto px-4 lg:px-8">
              ...
              >
                Fixed welfare cabins for longer-term projects.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl text-center">
          ...
          <p className="text-muted-foreground leading-relaxed">
            We're putting the finishing touches on this page. Check back shortly for full details on our static welfare cabins solutions, or get in touch with our team for immediate enquiries.
          </p>
        </div>
      </section>
